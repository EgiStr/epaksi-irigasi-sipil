...
// Schema untuk create PAI - simple dan fleksibel
export const createPAISchema = z.object({
  ...
  paiData: z.json(),
  photos: z.array(photoSchema).max(10, 'Maksimal 10 foto').optional(),
})
...
export const queryPAISchema = z.object({
  ...
  latest: z.string().optional().transform(val => val === 'true')
})
