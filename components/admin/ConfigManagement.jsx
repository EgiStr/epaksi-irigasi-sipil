...
const ConfigManagement = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {isModalOpen && (
        <div className="config-modal-overlay fixed inset-0" style={{ zIndex: 1001 }}>
          <div className="config-modal-content fixed bg-white rounded-3xl shadow-2xl max-h-[80vh] flex flex-col" style={{ 
            zIndex: 1002,
            maxWidth: '800px', 
            width: 'calc(100% - 2rem)',
            left: '50%',
